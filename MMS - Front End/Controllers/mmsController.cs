...
namespace BeeAware.Controllers
{
    ...
    public class mmsController : ControllerBase
    {
        ...
        public mmsController(IConfiguration configuration) // [ModuleName]Controller
        {
        ...
        [Route("mms")] // the route to fetch as api/[ModuleName]/[Route]. e.g: This one is for api/mms/Home (originally api/exp/Test)
        [ProducesResponseType(StatusCodes.Status200OK)] // passibile response
        public ContentResult mmsTest()  // same method name as route
        {
